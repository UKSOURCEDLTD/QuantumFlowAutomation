                    ...
                    <div className="bg-black/40 backdrop-blur-md p-10 border border-white/10">
                        ...
                        {status === "sent" ? (
                            <div className="text-center py-20 text-green-500">
                                <Send className="w-16 h-16 mx-auto mb-4" aria-hidden="true" />
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    <label htmlFor="network-name" className="block text-xs uppercase tracking-widest text-gray-500 mb-2">Name</label>
                                    <input
                                        id="network-name"
                                        type="text"
                                        required
                                ...
                                <div>
                                    <label htmlFor="network-org" className="block text-xs uppercase tracking-widest text-gray-500 mb-2">Company</label>
                                    <input
                                        id="network-org"
                                        type="text"
                                        required
                                ...
                                <div>
                                    <label htmlFor="network-email" className="block text-xs uppercase tracking-widest text-gray-500 mb-2">Email</label>
                                    <input
                                        id="network-email"
                                        type="email"
                                        required
                                ...
                                <div>
                                    <label htmlFor="network-message" className="block text-xs uppercase tracking-widest text-gray-500 mb-2">Message</label>
                                    <textarea
                                        id="network-message"
                                        rows={4}
                                        required
