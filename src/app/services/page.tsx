    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-primary/30 font-sans">
            ...
            <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-primary/10 rounded-full blur-[120px] mix-blend-screen opacity-50 pointer-events-none" />
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <PricingCard
                            ...
                            price="£500"
                            description="90-min deep dive call + written report with top 5 AI opportunities."
                            features={["90 Minute Call", "Written Report", "Top 5 Opportunities", "Implementation Roadmap"]}
                        />
                        <PricingCard
                            title="Strategic Retainer"
                            price="£750/mo"
                            description="Your ongoing AI strategy partner. Monthly calls & priority access."
                        ...
                        <PricingCard
                            title="Full Audit"
                            price="£2,000"
                            description="Comprehensive operational analysis with staff interviews."
            ...
            <section id="websites" className="py-32 border-t border-white/5 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                        ...
                        <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                            ...
                            <p className="text-sm text-gray-400">Personalise pages based on visitor behaviour.</p>
                        </div>
                        <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                            <Database className="w-8 h-8 text-purple-400 mb-4" />
                            <h3 className="font-bold mb-2">Smart Lead Capture</h3>
            ...
            <section id="employee" className="py-32 border-t border-white/5 relative overflow-hidden">
                {/* Background glow for this section */}
                <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-green-500/5 rounded-full blur-[100px] pointer-events-none" />
